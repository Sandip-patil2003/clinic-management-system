...
public class PatientService : IPatientService
{
    ...
    public async Task<List<PatientResponse>> GetAllAsync()
    {
        ...
        return list.Select(p => new PatientResponse { PatientId = p.PatientId, Name = p.Name, Mobile = p.Mobile, Age = p.Age, Gender = p.Gender }).ToList();
    }
    ...
    public async Task<PatientResponse?> UpdateAsync(Guid id, CreatePatientRequest request)
    {
        ...
        return new PatientResponse { PatientId = updated.PatientId, Name = updated.Name, Mobile = updated.Mobile, Age = updated.Age, Gender = updated.Gender };
    }
